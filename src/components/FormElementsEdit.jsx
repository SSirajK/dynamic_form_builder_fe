            ...
            <div>
                ...
                {this.props.element.hasOwnProperty('label') &&
                    <div className="form-group">
                        ...
                        <div className="custom-control custom-checkbox">
                            <input id="is-actions" className="custom-control-input" type="checkbox" checked={this.props.element.hasOwnProperty('actions') ? this.props.element.actions : false} value={true} onChange={this.editElementProp.bind(this, 'actions', 'checked')} />
                            <label className="custom-control-label" htmlFor="is-actions">
